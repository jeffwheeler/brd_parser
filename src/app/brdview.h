...
class BrdView : public QGraphicsView {
   ...
   public:
    ...
    void drawX15(const x15<A_174> *inst, QPainterPath *path);
    void drawX16(const x16<A_174> *inst, QPainterPath *path);
    void drawX17(const x17<A_174> *inst, QPainterPath *path);
    void drawX23(const x23<A_174> *inst, QPen *pen);
    void drawX28(const x28<A_174> *inst, QPen *pen);
    void drawX2B(const x2B<A_174> *inst, QPen *pen);
    void drawX2D(const x2D<A_174> *inst, QPen *pen);
    void drawX30(const x30<A_174> *inst, QPen *pen);
    void drawX32(const x32<A_174> *inst, QPen *pen, uint32_t sym_rotation);
    void drawX33(const x33<A_174> *inst, QPen *pen);
    void drawX34(const x34<A_174> *inst, QPen *pen);
