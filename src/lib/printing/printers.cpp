...
void print_struct(const uint32_t k, File<version> &fs, const int d) {
    ...
    } else if (fs.has_x14(k)) {
        print_struct((const void *)fs.ptrs[k], &fs, d);
    } else if (fs.has_x15(k)) {
        print_struct((const void *)fs.ptrs[k], &fs, d);
    } else if (fs.has_x16(k)) {
        print_struct((const void *)fs.ptrs[k], &fs, d);
    } else if (fs.has_x17(k)) {
        print_struct((const void *)fs.ptrs[k], &fs, d);
    } else if (fs.has_x1B(k)) {
        print_struct((const void *)fs.ptrs[k], &fs, d);
...
void print_x01(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    } else if (fs->has_x17(inst->next)) {
        print_struct((const void *)fs->ptrs[inst->next], fs, d + 2);
    } else if (fs->has_x16(inst->next)) {
        print_struct((const void *)fs->ptrs[inst->next], fs, d + 2);
    } else if (fs->has_x15(inst->next)) {
        print_struct((const void *)fs->ptrs[inst->next], fs, d + 2);
    } else if (fs->has_x14(inst->next)) {
        print_struct((const void *)fs->ptrs[inst->next], fs, d + 2);
    } else if (fs->x05_map.count(inst->next) > 0) {
        print_struct((const void *)&fs->x05_map.at(inst->next), fs, d + 2);
    } else if (fs->has_x01(inst->next)) {
        print_struct((const void *)fs->ptrs[inst->next], fs, d + 2);
    } else {
    ...
    } else if (fs->has_x17(inst->parent)) {
        print_struct((const void *)fs->ptrs[inst->parent], fs, d + 2);
    } else if (fs->has_x16(inst->parent)) {
        print_struct((const void *)fs->ptrs[inst->parent], fs, d + 2);
    } else if (fs->has_x15(inst->parent)) {
        print_struct((const void *)fs->ptrs[inst->parent], fs, d + 2);
    } else if (fs->has_x14(inst->parent)) {
        print_struct((const void *)fs->ptrs[inst->parent], fs, d + 2);
    } else if (fs->x05_map.count(inst->parent) > 0) {
        print_struct((const void *)&fs->x05_map.at(inst->parent), fs, d + 2);
    } else if (fs->has_x01(inst->parent)) {
        print_struct((const void *)fs->ptrs[inst->parent], fs, d + 2);
    } else {
...
void print_x05(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    } else if (fs->has_x17(inst->ptr0)) {
        print_struct((const void *)fs->ptrs[inst->ptr0], fs, d + 2);
    } else if (fs->has_x16(inst->ptr0)) {
        print_struct((const void *)fs->ptrs[inst->ptr0], fs, d + 2);
    } else if (fs->has_x15(inst->ptr0)) {
        print_struct((const void *)fs->ptrs[inst->ptr0], fs, d + 2);
    } else if (fs->has_x14(inst->ptr0)) {
        print_struct((const void *)fs->ptrs[inst->ptr0], fs, d + 2);
...
void print_x07(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    if constexpr (!std::is_same_v<decltype(inst->ptr0), std::monostate>) {
        printf_d(d + 1, "ptr0:\n");
        if (HAS_ENTRY(x06_map, inst->ptr0)) {
            PRINT(x06_map, inst->ptr0, d + 2);
        } else {
            printf_d(d + 2, "ptr0 unrecognized: 0x%08X\n", ntohl(inst->ptr0));
            // exit(0);
        }
    ...
    if (HAS_ENTRY(x10_map, inst->ptr2)) {
        PRINT(x10_map, inst->ptr2, d + 2);
    } else {
        printf_d(d + 2, "ptr2 unrecognized: 0x%08X\n", ntohl(inst->ptr2));
        exit(0);
    }
...
void print_x08(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    if (inst->ptr4 == 0) {
        ...
        std::printf("\n");
        if (fs->x31_map.count(inst->ptr4) > 0) {
            print_struct((const void *)&fs->x31_map.at(inst->ptr4), fs, d + 2);
        } else if (fs->x31_map.count(inst->ptr4) > 0) {
            print_struct((const void *)&fs->x31_map.at(inst->ptr4), fs, d + 2);
        } else if (fs->x30_map.count(inst->ptr4) > 0) {
            print_struct((const void *)&fs->x30_map.at(inst->ptr4), fs, d + 2);
        } else if (fs->x2D_map.count(inst->ptr4) > 0) {
            print_struct((const void *)&fs->x2D_map.at(inst->ptr4), fs, d + 2);
        ...
        } else if (fs->x08_map.count(inst->ptr4) > 0) {
            print_struct((const void *)&fs->x08_map.at(inst->ptr4), fs, d + 2);
...
void print_x12(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    } else if (HAS_ENTRY(x10_map, inst->ptr1)) {
        PRINT(x10_map, inst->ptr1, d + 2);
    } else {
        printf_d(d + 2, "ptr1 unrecognized: 0x%08X\n", ntohl(inst->ptr1));
        exit(0);
    }
    ...
    printf_d(d + 1, "ptr3:\n");
    if (HAS_ENTRY(x32_map, inst->ptr3)) {
        PRINT(x32_map, inst->ptr3, d + 2);
    } else {
        printf_d(d + 2, "ptr3 unrecognized: 0x%08X\n", ntohl(inst->ptr3));
        exit(0);
    }
...
void print_x1E(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    if (inst->hdr.str_ptr == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x03_map, inst->hdr.str_ptr)) {
            PRINT(x03_map, inst->hdr.str_ptr, d + 2);
        } else {
...
void print_x23(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    */
    ...
    printf_d(d + 1, "ptr1:\n");
    if (HAS_ENTRY(x32_map, inst->ptr1)) {
        PRINT(x32_map, inst->ptr1, d + 2);
    } else {
        printf_d(d + 2, "ptr1 unrecognized: 0x%08X\n", ntohl(inst->ptr1));
        exit(0);
    }
    ...
    if (inst->ptr2 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x23_map, inst->ptr2)) {
            PRINT(x23_map, inst->ptr2, d + 2);
        } else {
            printf_d(d + 2, "ptr2 unrecognized: 0x%08X\n", ntohl(inst->ptr2));
            exit(0);
        }
...
void print_x26(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    if (HAS_ENTRY(x33_map, inst->member_ptr)) {
        PRINT(x33_map, inst->member_ptr, d + 2);
    } else if (HAS_ENTRY(x32_map, inst->member_ptr)) {
        PRINT(x32_map, inst->member_ptr, d + 2);
    } else if (HAS_ENTRY(x30_map, inst->member_ptr)) {
    ...
    */
    ...
    if (inst->const_ptr == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x03_map, inst->const_ptr)) {
            PRINT(x03_map, inst->const_ptr, d + 2);
        } else {
...
void print_x28(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    */
    ...
    if (inst->ptr6 != 0) {
        printf_d(d + 1, "ptr6:\n");
        if (fs->x32_map.count(inst->ptr6) > 0) {
            print_struct((const void *)&fs->x32_map.at(inst->ptr6), fs, d + 2);
        } else if (fs->x17_map.count(inst->ptr6) > 0) {
            print_struct((const void *)&fs->x17_map.at(inst->ptr6), fs, d + 2);
        } else if (fs->x16_map.count(inst->ptr6) > 0) {
            print_struct((const void *)&fs->x16_map.at(inst->ptr6), fs, d + 2);
        } else if (fs->x15_map.count(inst->ptr6) > 0) {
            print_struct((const void *)&fs->x15_map.at(inst->ptr6), fs, d + 2);
        } else if (fs->x14_map.count(inst->ptr6) > 0) {
            print_struct((const void *)&fs->x14_map.at(inst->ptr6), fs, d + 2);
        } else if (fs->x07_map.count(inst->ptr6) > 0) {
            print_struct((const void *)&fs->x07_map.at(inst->ptr6), fs, d + 2);
        } else if (fs->x03_map.count(inst->ptr6) > 0) {
            print_struct((const void *)&fs->x03_map.at(inst->ptr6), fs, d + 2);
        } else {
            printf_d(d + 2, "ptr6 unrecognized: 0x%08X\n", ntohl(inst->ptr6));
            exit(0);
...
void print_x2B(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    */
    ...
    if (inst->ptr2 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x2D_map, inst->ptr2)) {
            PRINT(x2D_map, inst->ptr2, d + 2);
        } else {
            printf_d(d + 2, "ptr2 unrecognized: 0x%08X\n", ntohl(inst->ptr2));
            exit(0);
        }
    ...
    if (inst->ptr4 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x32_map, inst->ptr4)) {
            PRINT(x32_map, inst->ptr4, d + 2);
        } else {
            printf_d(d + 2, "ptr4 unrecognized: 0x%08X\n", ntohl(inst->ptr4));
            exit(0);
        }
    ...
    */
    ...
    if (inst->str_ptr == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x03_map, inst->str_ptr)) {
            PRINT(x03_map, inst->str_ptr, d + 2);
        } else {
            printf_d(d + 2, "str_ptr unrecognized: 0x%08X\n",
                     ntohl(inst->str_ptr));
            exit(0);
    ...
    if (inst->ptr6 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x28_map, inst->ptr6)) {
            PRINT(x28_map, inst->ptr6, d + 2);
        } else if (HAS_ENTRY(x0E_map, inst->ptr6)) {
            PRINT(x0E_map, inst->ptr6, d + 2);
        } else {
            printf_d(d + 2, "ptr6 unrecognized: 0x%08X\n", ntohl(inst->ptr6));
            exit(0);
        }
    ...
    if (inst->ptr7 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x28_map, inst->ptr7)) {
            PRINT(x28_map, inst->ptr7, d + 2);
        } else if (HAS_ENTRY(x24_map, inst->ptr7)) {
            PRINT(x24_map, inst->ptr7, d + 2);
        } else {
            printf_d(d + 2, "ptr7 unrecognized: 0x%08X\n", ntohl(inst->ptr7));
            exit(0);
        }
    ...
    if (inst->ptr8 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x33_map, inst->ptr8)) {
            PRINT(x33_map, inst->ptr8, d + 2);
        } else if (HAS_ENTRY(x28_map, inst->ptr8)) {
            PRINT(x28_map, inst->ptr8, d + 2);
        } else {
...
void print_x2C(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    if (inst->ptr1 == 0) {
        ...
        } else if (HAS_ENTRY(x37_map, inst->ptr1)) {
            PRINT(x37_map, inst->ptr1, d + 2);
        } else {
            printf_d(d + 2, "ptr1 unrecognized: 0x%08X\n", ntohl(inst->ptr1));
            exit(0);
        }
    ...
    if (inst->ptr2 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x03_map, inst->ptr2)) {
            PRINT(x03_map, inst->ptr2, d + 2);
        } else {
            printf_d(d + 2, "ptr2 unrecognized: 0x%08X\n", ntohl(inst->ptr2));
            exit(0);
        }
    ...
    if (inst->ptr3 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x2C_map, inst->ptr3)) {
            PRINT(x2C_map, inst->ptr3, d + 2);
        } else if (HAS_ENTRY(x26_map, inst->ptr3)) {
            PRINT(x26_map, inst->ptr3, d + 2);
        } else {
            printf_d(d + 2, "ptr3 unrecognized: 0x%08X\n", ntohl(inst->ptr3));
            exit(0);
        }
...
void print_x2D(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    if constexpr (std::is_same_v<decltype(inst->inst_ref), std::monostate>) {
        ...
        if (inst->inst_ref == 0) {
            ...
            std::printf("\n");
            if (HAS_ENTRY(x07_map, inst->inst_ref)) {
    ...
    */
    ...
    if (inst->group_assignment_ptr == 0) {
        ...
        std::printf("\n");
        if (fs->x2C_map.count(inst->group_assignment_ptr) > 0) {
            print_struct(
                (const void *)&fs->x2C_map.at(inst->group_assignment_ptr), fs,
                d + 2);
        } else if (fs->x26_map.count(inst->group_assignment_ptr) > 0) {
            print_struct(
        ...
        if (inst->ptr3 != 0) {
            ...
            if (fs->x01_map.count(inst->ptr3) > 0) {
                ...
                print_struct((const void *)&fs->x09_map.at(inst->ptr3), fs,
                             d + 2);
            } else if (fs->x0E_map.count(inst->ptr3) > 0) {
                ...
                print_struct((const void *)&fs->x1F_map.at(inst->ptr3), fs,
                             d + 2);
            } else if (fs->x30_map.count(inst->ptr3) > 0) {
                print_struct((const void *)&fs->x30_map.at(inst->ptr3), fs,
                             d + 2);
            } else if (fs->x32_map.count(inst->ptr3) > 0) {
                print_struct((const void *)&fs->x32_map.at(inst->ptr3), fs,
                             d + 2);
            } else if (fs->x24_map.count(inst->ptr3) > 0) {
                print_struct((const void *)&fs->x24_map.at(inst->ptr3), fs,
                             d + 2);
            } else if (fs->x26_map.count(inst->ptr3) > 0) {
                print_struct((const void *)&fs->x26_map.at(inst->ptr3), fs,
                             d + 2);
            } else if (fs->x28_map.count(inst->ptr3) > 0) {
                print_struct((const void *)&fs->x28_map.at(inst->ptr3), fs,
                             d + 2);
...
void print_x32(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    if (inst->ptr1 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x04_map, inst->ptr1)) {
            PRINT(x04_map, inst->ptr1, d + 2);
        } else {
            printf_d(d + 2, "ptr1 unrecognized: 0x%08X\n", ntohl(inst->ptr1));
            exit(0);
        }
    ...
    printf_d(d + 1, "next:\n");
    if (HAS_ENTRY(x32_map, inst->next)) {
    ...
    if (inst->ptr4 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x09_map, inst->ptr4)) {
            PRINT(x09_map, inst->ptr4, d + 2);
        } else if (HAS_ENTRY(x05_map, inst->ptr4)) {
            PRINT(x05_map, inst->ptr4, d + 2);
        } else {
            printf_d(d + 2, "ptr4 unrecognized: 0x%08X\n", ntohl(inst->ptr4));
            exit(0);
        }
    ...
    if (inst->ptr7 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x23_map, inst->ptr7)) {
            PRINT(x23_map, inst->ptr7, d + 2);
        } else {
            printf_d(d + 2, "ptr7 unrecognized: 0x%08X\n", ntohl(inst->ptr7));
            exit(0);
        }
    ...
    if (inst->ptr8 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x08_map, inst->ptr8)) {
            PRINT(x08_map, inst->ptr8, d + 2);
        } else {
            printf_d(d + 2, "ptr8 unrecognized: 0x%08X\n", ntohl(inst->ptr8));
            exit(0);
        }
    ...
    */
    ...
    if (inst->ptr10 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x30_map, inst->ptr10)) {
            PRINT(x30_map, inst->ptr10, d + 2);
        } else if (HAS_ENTRY(x03_map, inst->ptr10)) {
            PRINT(x03_map, inst->ptr10, d + 2);
        } else {
    ...
    if (inst->ptr11 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x26_map, inst->ptr11)) {
            PRINT(x26_map, inst->ptr11, d + 2);
        } else {
...
void print_x33(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    if (inst->ptr4 == 0) {
        ...
        std::printf("\n");
        if (fs->x2F_map.count(inst->ptr4) > 0) {
            print_struct((const void *)&fs->x2F_map.at(inst->ptr4), fs, d + 2);
    ...
    if (inst->ptr6 == 0) {
        ...
        std::printf(" -\n");
        if (fs->x2C_map.count(inst->ptr6) > 0) {
            print_struct((const void *)&fs->x2C_map.at(inst->ptr6), fs, d + 2);
        } else if (fs->x26_map.count(inst->ptr6) > 0) {
...
void print_x34(const void *untyped_inst, File<version> *fs, const int d) {
    ...
    printf_d(d + 1, "ptr1:\n");
    if (HAS_ENTRY(x28_map, inst->ptr1)) {
        PRINT(x28_map, inst->ptr1, d + 2);
    } else {
        printf_d(d + 2, "ptr1 unrecognized: 0x%08X\n", ntohl(inst->ptr1));
        exit(0);
    }
    ...
    */
    ...
    if (inst->ptr3 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x03_map, inst->ptr3)) {
            PRINT(x03_map, inst->ptr3, d + 2);
        } else {
            printf_d(d + 2, "ptr3 unrecognized: 0x%08X\n", ntohl(inst->ptr3));
            exit(0);
        }
...
void print_x36_x0F(const x36_x0F<version> &x, File<version> *fs, const int d) {
    ...
    for (uint8_t i = 0; i < 3; i++) {
        ...
        if (x.ptrs[i] == 0) {
            ...
            std::printf("\n");
            if (HAS_ENTRY(x2C_map, x.ptrs[i])) {
                PRINT(x2C_map, x.ptrs[i], d + 2);
            } else {
    ...
    if (x.ptr2 == 0) {
        ...
        std::printf("\n");
        if (HAS_ENTRY(x03_map, x.ptr2)) {
            PRINT(x03_map, x.ptr2, d + 2);
        } else {
            printf_d(d + 2, "ptr2 unrecognized: 0x%08X\n", ntohl(x.ptr2));
            exit(0);
        }
