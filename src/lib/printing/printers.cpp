...
template <AllegroVersion version>
void print_x22(const void *untyped_inst, File<version> *, const int d) {
...
void print_x24(const void *untyped_inst, File<version> *fs, const int d) {
  const uint32_t k = ((const x24<version> *)untyped_inst)->k;
  x24<version> inst = fs->get_x24(k);
  printf_d(d,
...
template <AllegroVersion version>
void print_x3C(const void *untyped_inst, File<version> *, const int d) {
